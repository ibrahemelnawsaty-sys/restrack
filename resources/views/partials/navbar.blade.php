...
<header class="bar rise in">
        ...
        <div class="bar-actions">
            ...
            @auth
                @if (auth()->user()->isAdmin())
                    <a class="login" href="{{ route('admin.dashboard') }}">لوحة الإدارة</a>
                @endif
                <a class="btn btn-gold-line btn-sm bar-cta" href="{{ route('dashboard') }}">لوحتي</a>
    ...
    <div class="mobile-menu glass" id="mobileMenu">
        ...
        @auth
            ...
            @if (auth()->user()->isAdmin())<a href="{{ route('admin.dashboard') }}">لوحة الإدارة</a>@endif
