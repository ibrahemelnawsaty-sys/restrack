...
@section('title', 'شهاداتي — Restrack')

@section('content')
  <section class="page">
    <div class="page-head rise in">
      <span class="eyebrow"><svg class="ico" aria-hidden="true"><use href="#i-award"/></svg>الشهادات</span>
      <h1>شهاداتي</h1>
      <p>شهادات موثّقة بتحقّق QR — قابلة للمشاركة على لينكدإن وواتساب.</p>
    </div>

    @if ($certificates->isEmpty())
      <div class="glass tile rise in" style="text-align:center;padding:34px">
        <p style="color:var(--ink-2)">لا توجد شهادات بعد. اجتَز اختبار أي مستوى (70%) لتحصل على أول شهادة.</p>
        <a class="btn btn-gold" href="{{ route('program.index') }}" style="margin-top:14px"><span class="sheen"></span>ابدأ المسار</a>
      </div>
    @else
