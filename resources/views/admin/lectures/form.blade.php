...
@section('title', ($lecture->exists ? 'تعديل' : 'إضافة').' محاضرة — الإدارة')
...
@section('content')
  <section class="page">
    ...
    <form method="POST" action="{{ $lecture->exists ? route('admin.lectures.update', $lecture) : route('admin.lectures.store') }}" class="glass tile rise in" enctype="multipart/form-data">
      @csrf
